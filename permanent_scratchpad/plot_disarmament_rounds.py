...
def create_disarmament_rounds_plot():
    ...
    payoff_file = 'outputs/2025/09/17/00:15_disarmament__openai-gpt-oss-20b-cot__deepseek-deepseek-chat-v3-1-cot__qwen-qwen3-next-80b-a3b-instruct__openai-gpt-5-nano-cot/payoffs.json'
    ...
    # Save figure
    output_path = 'permanent_scratchpad/disarmament_rounds_analysis.png'
