...
def create_deepseek_trajectory_plot():
    ...
    payoff_file = 'outputs/2025/09/16/17:07_repetition__openai-gpt-oss-20b-cot__deepseek-deepseek-chat-v3-1-cot__qwen-qwen3-next-80b-a3b-instruct__openai-gpt-5-nano-cot/payoffs.json'
    ...
    # Save figure
    output_path = 'permanent_scratchpad/deepseek_trajectory_repetition.png'
