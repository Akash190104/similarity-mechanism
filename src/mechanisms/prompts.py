...
# Similarity mechanism prompts
SIMILARITY_MECHANISM_PROMPT_SINGLE = textwrap.dedent(
    """
    Here is the twist:
    {similarity_framing}
    """
...
SIMILARITY_MECHANISM_PROMPT_REPEATED = textwrap.dedent(
    """
    Here is the twist:
...
SIMILARITY_PERCENTAGE_FRAMING = (
    "Your opponent is {similarity_pct}% {measure_word} you."
    " Remember, the other agent is seeing this information as well."
)
SIMILARITY_PERCENTAGE_FRAMING_MULTI = (
    "Each of the other {num_other_players} agents is {similarity_pct}% {measure_word} you."
    " Remember, the other agents are seeing this information as well."
)

SIMILARITY_PERCENTAGE_UPDATED_FRAMING = (
    "The other agent's decision-making is {similarity_pct}% {measure_word} yours,"
    " meaning, this is how {relation_word} you and the other agent reason and come to"
    " conclusions when facing the same strategic problem."
    " Note, however, you and the other agent are independently trying to"
    " maximize your own total points."
    " Remember, the other agent is seeing this information as well."
)
SIMILARITY_PERCENTAGE_UPDATED_FRAMING_MULTI = (
    "Each of the other {num_other_players} agents' decision-making is"
    " {similarity_pct}% {measure_word} yours,"
    " meaning, this is how {relation_word} you and the other agents reason and come to"
    " conclusions when facing the same strategic problem."
    " Note, however, you and the other agents are independently trying to"
    " maximize your own total points."
    " Remember, the other agents are seeing this information as well."
)

SIMILARITY_DOMAIN_FRAMING = (
    "Your opponent is {similarity_pct}% {measure_word} you in the domain of {domain}."
    " Remember, the other agent is seeing this information as well."
)
SIMILARITY_DOMAIN_FRAMING_MULTI = (
    "Each of the other {num_other_players} agents is {similarity_pct}% {measure_word}"
    " you in the domain of {domain}."
    " Remember, the other agents are seeing this information as well."
)

SIMILARITY_VAGUE_FRAMING = (
    "You are playing an opponent that has some similarity to you."
    " Remember, the other agent is seeing this information as well."
)

SIMILARITY_CONSTRUCT_FRAMING = (
    "A similarity score between you and the other agent has been computed,"
    " ranging from 0 to 1, but it is currently not available for display."
    " Remember, the other agent is seeing this information as well."
)
SIMILARITY_CONSTRUCT_FRAMING_MULTI = (
    "Similarity scores between you and each of the other {num_other_players} agents"
    " have been computed, ranging from 0 to 1, but they are currently not available for display."
    " Remember, the other agents are seeing this information as well."
)

SIMILARITY_CUSTOM_FRAMING = "{custom_text}"

SIMILARITY_NO_HISTORY = "No rounds have been played yet."

SIMILARITY_ROUND_LINE = "[Round {round_idx}]\n{actions}"
SIMILARITY_SELF_LABEL = "\tYou: {action_token}"
SIMILARITY_OTHERPLAYER_LABEL = "\t{other_player}: {action_token}"
